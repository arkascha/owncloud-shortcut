...
$tmpl = new OCP\Template('shortcut', 'admin');
$tmpl->assign('shortcut-share-base-url', OCP\Config::getAppValue('shortcut', 'share-base-url', ''));
$tmpl->assign('shortcut-share-base-placeholder', 'http?://<host>/path/');
